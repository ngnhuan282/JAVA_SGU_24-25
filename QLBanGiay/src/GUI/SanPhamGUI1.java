...
public class SanPhamGUI1 extends JFrame implements ActionListener{
	...
	public void openFixProductGUI(java.awt.event.ActionEvent evt) {
	    ...
	    btnSuaSP.addActionListener(new ActionListener() {
	        ...
	        public void actionPerformed(ActionEvent e) {
	            ...
	            if (maSP.isEmpty() || tenSP.isEmpty() || donGia.isEmpty() || maLoaiSP.isEmpty() || soLuong.isEmpty()) {
	                JOptionPane.showMessageDialog(fixProductDialog, "Vui lòng điền đầy đủ thông tin!", "Lỗi", JOptionPane.ERROR_MESSAGE);
	                return;
	            }
	            ...
	            try {
	                ...
	                table.setValueAt(maSP, selectedRow, 0);
	                table.setValueAt(tenSP, selectedRow, 1);
	                table.setValueAt(maLoaiSP, selectedRow, 2);
	                table.setValueAt(donGiaValue, selectedRow, 3);
	                table.setValueAt(soLuongValue, selectedRow, 4);
	                ...
	                // Hiển thị thông báo
	                JOptionPane.showMessageDialog(fixProductDialog, "Cập nhật thành công!", "Thông báo", JOptionPane.INFORMATION_MESSAGE);

	                // Đóng cửa sổ sửa sản phẩm
	                fixProductDialog.dispose();
	            } catch (NumberFormatException ex) {
	                JOptionPane.showMessageDialog(fixProductDialog, "Đơn giá và số lượng phải là số!", "Lỗi", JOptionPane.ERROR_MESSAGE);
	            }
	        }
	    });
