...
public class SanPhamGUIVer1 extends JFrame implements ActionListener {
...
//    private SanPhamBUS spBUS = new SanPhamBUS();
    ...
    public static void main(String[] args) {
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    SanPhamGUIVer1 frame = new SanPhamGUIVer1();
...
//    }
    ...
    public void initComponents() {
        ...
        lbInfo1.setIcon(new ImageIcon(SanPhamGUIVer1.class.getResource("/image/userIcon.png")));
        ...
        btnDangXuat.setIcon(new ImageIcon(SanPhamGUIVer1.class.getResource("/image/logoutIcon.png")));
        ...
        btnTrangChuGUI.setIcon(new ImageIcon(SanPhamGUIVer1.class.getResource("/image/homeIcon.png")));
        ...
        btnSanPhamGUI.setIcon(new ImageIcon(SanPhamGUIVer1.class.getResource("/image/productIcon.png")));
        ...
        btnNhaCungCapGUI.setIcon(new ImageIcon(SanPhamGUIVer1.class.getResource("/image/providerIcon.png")));
        ...
        btnNhanVienGUI.setIcon(new ImageIcon(SanPhamGUIVer1.class.getResource("/image/employeeIcon.png")));
        ...
        btnKhachHangGUI.setIcon(new ImageIcon(SanPhamGUIVer1.class.getResource("/image/clientIcon.png")));
        ...
        btnPhieuNhapGUI.setIcon(new ImageIcon(SanPhamGUIVer1.class.getResource("/image/phieuNhap.png")));
        ...
        btnPhieuXuat.setIcon(new ImageIcon(SanPhamGUIVer1.class.getResource("/image/phieuXuat.png")));
        ...
        btnKhuyenMaiGUI.setIcon(new ImageIcon(SanPhamGUIVer1.class.getResource("/image/saleIcon.png")));
        ...
        btnThem.setIcon(new ImageIcon(SanPhamGUIVer1.class.getResource("/image/add48.png")));
        ...
        btnSua.setIcon(new ImageIcon(SanPhamGUIVer1.class.getResource("/image/edit48.png")));
        ...
        btnXoa.setIcon(new ImageIcon(SanPhamGUIVer1.class.getResource("/image/remove48.png")));
        ...
        btnXuatExcel.setIcon(new ImageIcon(SanPhamGUIVer1.class.getResource("/image/excel48.png")));
        ...
        btnNhapExcel.setIcon(new ImageIcon(SanPhamGUIVer1.class.getResource("/image/bill48.png")));
        ...
        btnSearch.setIcon(new ImageIcon(SanPhamGUIVer1.class.getResource("/image/seach48.png")));
        ...
        scrollPane.setBounds(629, 40, 575, 363);
        pContent.add(scrollPane);
        
        JPanel pInput = new JPanel();
        pInput.setBackground(Color.WHITE);
        pInput.setBounds(41, 29, 406, 251);
        pContent.add(pInput);
    }
